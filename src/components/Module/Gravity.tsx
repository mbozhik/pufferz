...
import {calculatePosition} from '@/utils/module-gravity'
import {parsePathToVertices} from '@/utils/module-gravity'
...
const Gravity = forwardRef<GravityRef, GravityProps>(({children, debug = false, gravity = {x: 0, y: 1}, grabCursor = true, resetOnResize = true, addTopWall = true, autoStart = true, className, ...props}, ref) => {
